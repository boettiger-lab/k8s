#!/bin/bash
# gpu-hang-watchdog.sh -- detect and recover from the GB10 GPU wedge.
#
# Failure signature we are recovering from (nimbus, 2026-08-24 -- same silicon,
# so it applies to every GB10 in the fleet):
